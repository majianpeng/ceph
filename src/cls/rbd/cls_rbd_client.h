...
int rwlcache_daemonping(librados::IoCtx *ioct, struct cls::rbd::RwlCacheDaemonPing &req);
...
int rwlcache_request_replyack(librados::IoCtx *ioct, struct cls::rbd::RwlCacheRequestReplyAck &req);
